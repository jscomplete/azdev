...
VALUES
(E'calculate-the-sum-of-numbers-in-javascript-array-c164924d0d',E'Calculate the sum of numbers in a JavaScript array','42',FALSE,E'2021-03-03', 42),
...
(E'note',E'To do the hashing asynchronously, use the `bycrypt.hash` method. It returns a promise.','42',E'const-bcrypt-require-bcrypt-const-hashedpass-bcrypt-hashsync-testpass123-10-93ab24cabb',NULL,E'2021-03-03', 42),
